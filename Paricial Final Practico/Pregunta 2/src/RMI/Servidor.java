...
public class Servidor {
        ...
        try {
            ...
            if(Comando.equals("cadena" )){
                ...
                if(Comando.equals("factorial")){
                    toClient.println(ReturnFactorial(Mensaje));
                }
    ...
    public static int ReturnValue(String valor){
        ...
        System.out.println("Longitud de separado : "+ Separado.length);
        System.out.println("soy separado "+Separado[1]);
        int numero = TextToNumber(Separado[0].trim());
        return numero;
    }
