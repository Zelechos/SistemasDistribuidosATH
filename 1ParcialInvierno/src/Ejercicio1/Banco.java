...
public class Banco {
  ...
  //Metodo para Tratamiento de String
     ...
     //Subrutina para Recuperar el valor de tipo entero donde "Credito : CarnetIdentidad-Monto"
    public static String ReturnValue(String valor) {
        String[] Separado = valor.split("\\-");
        String CarnetIdentidad  = ReturnCarnetCliente(Separado[0].trim());
        return "riesgo:"+CarnetIdentidad;
    }
    
    //Subrutina para Recuperar el comando donde "Credito : CarnetIdentidad"
